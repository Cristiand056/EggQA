 ...
 */
package javarealcionesclasesejer3;

import java.util.ArrayList;
import javarealcionesclasesejer3.data.Cartas;
import javarealcionesclasesejer3.entiies.Baraja;
import javarealcionesclasesejer3.entiies.Carta;
import javarealcionesclasesejer3.services.BarajaService;

/**
 *
 * @author USER
 */
public class JavaRealcionesClasesEjer3 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        ArrayList<Carta> aux = Cartas.list;
        Baraja b = new Baraja(aux);
