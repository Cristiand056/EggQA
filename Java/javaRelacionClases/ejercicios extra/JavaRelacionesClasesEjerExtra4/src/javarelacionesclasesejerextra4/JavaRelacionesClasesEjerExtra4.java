 ...
 */
package javarelacionesclasesejerextra4;

import java.util.ArrayList;
import javarelacionesclasesejerextra4.data.utils.tools;
import javarelacionesclasesejerextra4.entities.Alumno;
import javarelacionesclasesejerextra4.entities.Simulador;
 ...
 * @author USER
 */
public class JavaRelacionesClasesEjerExtra4 {

    public static void main(String[] args) {
       Simulador s = new Simulador();
       
       ArrayList<Alumno> alumnos = s.crearAlumnos();
        System.out.println("Lista Alumnos--------------");
       tools.mostrarAlumnos(alumnos);
        System.out.println("Votos Alumnos-------------");
       ArrayList<Voto> votos = s.votacion(alumnos);
       
       tools.mostrarVotos(votos);
        System.out.println("Facilitadores------------");
       s.recuentoVotos(alumnos);
    }
